...
/*    JavaScript 7th Edition
      ...
      Rodriguez Ramon, september 17, 2023, IST239-W01, Hands-on Project 5-5
...
function scrambleTiles() {
   for (let i = 0; i < allTiles.length; i++) {
      ...
      let randomIndex = Math.floor(allTiles.length*Math.random() -1);
      ...
      allTiles[i].onclick = function() 
      {
         ...
         if (this.lastElementChild.className == "back") 
         {
            ...
            } else if (tilesFlipped === 2) 
            {
               ...
               secondFlipped = this;
               //secondFlipped.replaceChild(secondFlipped.firstElementChild);
